...
def RegistrarCultivo(request):
    ...
    template_name = 'nomina/catalogos/cultivos/registro_cultivo.html'
    context = {}
...
class ListaCultivos(LoginAndActiveMixin, PermisoNomina, ListView):
    model = Variedad
    template_name = 'nomina/catalogos/cultivos/lista_cultivos.html'
