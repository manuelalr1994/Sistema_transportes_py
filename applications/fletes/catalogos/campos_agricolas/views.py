...
class RegistrarCampos(LoginAndActiveMixin, PermisoFletes, CreateView):
    model = NomCampos
    form_class = FormularioCampos
    template_name = "fletes/catalogos/campos_agricolas/registro_campos.html"
    success_url = reverse_lazy('fletes:catalogos:campos:lista')
...
class ListaCampos(LoginAndActiveMixin, PermisoFletes, ListView):
    model = NomCampos
    template_name = "fletes/catalogos/campos_agricolas/lista_campos.html"
    login_url = reverse_lazy('users_app:user_login')
