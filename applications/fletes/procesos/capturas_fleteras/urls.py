...
urlpatterns = [
    ...
    path('cargar_datos_camion/', cargarInformacionCamion, name='cargarDatosCamion'),
    path('cargar_dias_camion/', cargarDiasCamion, name='cargarDiasCamion'),
